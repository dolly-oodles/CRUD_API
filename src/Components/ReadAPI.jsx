...
import { handleReadAPI, handleDeleteAPI, CRUD_APISelector } from "../Redux/CRUD_API.reducers";
...
const ReadAPI = () => {
  ...
  return (
    <div className="relative overflow-x-auto sm:rounded-lg">
      {editProduct && <EditProduct product={editProduct} onClose={handleCloseModal} />}
